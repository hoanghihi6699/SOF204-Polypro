...
public class KhoaHocJF extends javax.swing.JFrame {
    ...
    public boolean check() {
        if (txtNgayKG.getText().equals("") || txtHocPhi.getText().equals("") || txtThoiLuong.getText().equals("")
                || txtNgayTao.getText().equals("") || txtGhiChu.getText().equals("")) {
            DialogHelper.alert(rootPane, "Hãy nhập đủ dữ liệu sau đó ấn Save");
            return false;
        } else if (!(txtHocPhi.getText()).matches("[0-9]{1,9}")) {
            DialogHelper.alert(rootPane, "Học phí phải nhập số");
            txtHocPhi.requestFocus();
            return false;
        } else if (!(txtThoiLuong.getText()).matches("[0-9]{1,8}")) {
            DialogHelper.alert(rootPane, "Thời lượng phải nhập số");
    ...
    void openHocVien() {
        ...
        new HocVienJF(id).setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        txtGhiChu123 = new javax.swing.JScrollPane();
        ...
        txtGhiChu.setRows(5);
        txtGhiChu123.setViewportView(txtGhiChu);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel9)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtGhiChu123, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnInsert)
                    .addComponent(btnUpdate)
    ...
    private javax.swing.JScrollPane txtGhiChu123;
